...
_maxload = 1;
_neartransporttrucks = ((getpos _ammobox) nearEntities [JTFV_transport_classes, _max_transport_distance]) select {alive _x && speed _x < 5 && ((getpos _x) select 2) < 5};
...

{
    ...
    } foreach JTFV_transport_classes;
